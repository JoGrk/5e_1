...
CREATE USER edytor_1;
GRANT UPDATE, DELETE, INSERT, SELECT ON 5e_1_perfumy.* TO edytor_1;

-- 3. Utwórz użytkownika selektor z prawami do wyszukiwania danych w tabeli perfumy z hasłem 1234
CREATE USER selektor_1 identified by "1234";
...
REVOKE DELETE on 5e_1_perfumy.* from 'edytor_1';
