...
GRANT UPDATE,DELETE,SELECT,INSERT ON 5e_1_perfumy.* TO edytor_1;
...
GRANT SELECT ON 5e_1_perfumy.perfumy TO selektor_1;
-- 4. Nadaj hasło użytkownikowi edytor 1234 oraz użytkownikowi selektor 5678
SET PASSWORD FOR 'edytor_1' = PASSWORD('1234');
SET PASSWORD FOR 'selektor_1' = PASSWORD('5678');
-- 5. Odbierz użytkownikowi edytor prawo do usuwania danych z wszystkich tabel
REVOKE DELETE ON 5e_1_perfumy.* TO 'edytor_1';
...
DENY DELETE ON 5e_1_perfumy.sklad FROM 'selektor_1'; 