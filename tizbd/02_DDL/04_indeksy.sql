...
-- 4. Za polem address dodaj address2 (255 znaków)
 ALTER TABLE clients
 ADD column address2 varchar(255) AFTER address;
...
-- 12. dodaj więzy: dopuszczalne wartości pola state to LA, CO, KY,CA
 ALTER TABLE clients
 ADD constraint ck_state check(state IN ('LA','CO','KY','CA'));
